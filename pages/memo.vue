<tempate>
    <section class="container">
        ...
        <hr>
        <ul class="list">
            <li v-model="item in page_itemp" v-bind:key="item.indexOf" >
...
export default{
    ...
    computed:{
        mome:function(){return this.$store.state.memo.memo;},
        page_items: function(){
            if(this.find_flg){
                var arr =[];
                ...
                return arr;
            }else if(this.set_flg != false){
                return [this.set_flg];
            }else{
                return this.$store.state.mome.mome.slice(
                    this.num_per_page * this.$store.state.mome.mome
                    this.num_per_page * (this.$store.state.mome.mome+1));
            }
        },
        page:{
            function(){
            ...
            set: function(p){
                ...
                / this.num_per_page ?
                Math.ceil((this.$store.state.memo.memo - 1)
